...
const PROPERTY_TYPES = [
  { key: "apartment", label: "Apartment", color: "#10b981" },
  { key: "villa", label: "Villa", color: "#14b8a6" },
          ...
          {["3M", "6M", "8M"].map((p) => (
            <button
              ...
              className={`px-3 py-1 rounded-lg text-xs font-semibold transition-all ${
                activePeriod === p ? "bg-emerald-600 text-white" : "text-white/40 hover:text-white/60"
              }`}
            >
              {p}
            </button>
